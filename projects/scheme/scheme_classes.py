...
class Frame:
    ...
    def define(self, symbol, value):
        ...
        "*** YOUR CODE HERE ***"
        # END PROBLEM 1
        # add symbol into dictionary
        # can replace value for same symbol
    ...
    def lookup(self, symbol):
        ...
        # self is current frame, if it runs out, move to parents frame
        while current is not None:
            # check if current frame has symbol
            if symbol in current.bindings:
                return current.bindings[symbol]
            
            # no symbol, move to parent frame
            else:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # bind each formal to corresponding argument value
