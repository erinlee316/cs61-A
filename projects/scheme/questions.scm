...
(define (enumerate s)
  ...
  (begin
    ...
    (cond ((null? s) '()) 
      (else (cons (cons index (cons (car s) nil)) ; create list of two-element lists
        (helper (cdr s) (+ index 1)))))) ; recursively move through entire list

  (helper s 0)) ; start enumerating at index 0
)
  ; END PROBLEM 15
